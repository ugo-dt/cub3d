...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/13 12:52:16 by ugdaniel          #+#    #+#             */
/*   Updated: 2021/02/08 11:48:27 by ugdaniel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double			ray_distance(t_game *game, t_ray *ray)
{
	double	pos;
...
void			ray_cast(t_game *game, t_ray *ray, int column)
{
	...
	while (!hit)
	{
		...
		else if (get_value_in_map(&ray->map_pos, &game->config) == '1')
			hit = 1;
	}
