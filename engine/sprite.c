...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/01/18 21:49:51 by ugdaniel          #+#    #+#             */
/*   Updated: 2021/01/22 12:13:48 by ugdaniel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int
	set_tex_pos(t_game *game, t_sprite_draw *spr, t_texture *tex,
		t_pos *tex_pos)
{
	tex_pos->x = (int)(256
		...
		t_texture *tex)
{
	...
	if (set_tex_pos(game, spr, tex, &tex_pos))
	{
		color = shade_color(get_tex_color(tex, &tex_pos),
			(game->shadows) ? sprite->distance / 20 : 1);
		if (color != 0x0)
